...
public class GuestRepository : BaseRepository, IGuestRepository
{
    ...
    {
        var query = $@"INSERT INTO guest (guest_id,guest_name,guest_details,guest_city,guest_state) VALUES (@GuestId, @GuestName, @GuestDetails, @GuestCity, @GuestState) RETURNING * ";
